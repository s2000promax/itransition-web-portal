...
import cls from './ReviewListFilters.module.scss';
...
export const ReviewListFilters = memo((props: ReviewListFiltersProps) => {
    ...
    return (
        <div className={classNames(cls.ReviewListFilters, {}, [className])}>
